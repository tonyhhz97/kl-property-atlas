...
.btn-steel-blue-lt{background:#6e96e0;color:#fff;box-shadow:0 6px 20px rgba(110,150,224,.35)}
.btn-steel-blue-lt:hover{box-shadow:0 8px 26px rgba(110,150,224,.45)}
...
<section class="hero" id="sec-hero" data-sec-label="Hero / Headline">
  <div class="container">
    ...
    <div class="hero-cta">
      ...
      <a class="btn btn-steel-blue-lt" href="https://tonyhoo-home-loan-calculator.netlify.app/" target="_blank" rel="noopener">🧮 Home Loan Calculator</a>
    </div>
